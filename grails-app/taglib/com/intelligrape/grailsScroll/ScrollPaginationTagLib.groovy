...
class ScrollPaginationTagLib {
    ...
    def scroll = {attrs, body ->
        ...
        out << g.render(template: "/templateForGrailsScroll", model: [max: max, offset: offset, sort: fieldToSort, loadingElementURL: loadingElementURL, order: order, totalRecords: totalRecords, link: link, templateId: templateId, blockId: blockId])
    }
